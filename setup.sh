...
docker compose exec -i backend-news-laravel-api php artisan migrate:fresh --env=local
docker compose exec -i backend-news-laravel-api php artisan db:seed --env=local
